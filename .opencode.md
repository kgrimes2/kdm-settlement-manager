...
**Blended rate:** ~$25.79 per million tokens  
**Alternative pricing structure:**
- Input tokens: $3.00 per million tokens  
- Output tokens: $15.00 per million tokens  

**Note:** Actual costs may vary by region, tier (Standard/Priority/Flex), and usage patterns. The blended rate accounts for typical input/output ratios in OpenCode sessions. Use OpenCode's reported costs for accuracy.
